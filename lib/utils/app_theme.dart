...
class LightModeTheme extends AppTheme {
  ...
  late Color primary = const Color(0xFF62D5B4);
  late Color secondary = const Color(0xFF83EEC5);
  late Color tertiary = const Color(0xFF184A4A);
  late Color alternate = const Color(0xFF73AC31);
  late Color primaryText = const Color(0xFFDDDDDD);
  late Color secondaryText = const Color(0xFF141414);
